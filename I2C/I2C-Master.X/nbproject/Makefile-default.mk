...
SOURCEFILES_QUOTED_IF_SPACED=main.c I2C.c ADC.c LCD.c DS3232.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/DS3232.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/DS3232.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/DS3232.p1

# Source Files
SOURCEFILES=main.c I2C.c ADC.c LCD.c DS3232.c
...
${OBJECTDIR}/DS3232.p1: DS3232.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/DS3232.p1.d 
	@${RM} ${OBJECTDIR}/DS3232.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/DS3232.p1 DS3232.c 
	@-${MV} ${OBJECTDIR}/DS3232.d ${OBJECTDIR}/DS3232.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/DS3232.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
